...
|[getUsedRange(valuesOnly: boolean)](#getusedrangevaluesonly-boolean):new:|[Range](range.md)|Returns the used range of the given range object.|
...
| Parameter	   | Type	|Description|
|:---------------|:--------|:----------|
|valuesOnly|[boolean|Considers only cells with values as used cells.|
