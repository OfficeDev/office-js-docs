...
|[chartaxis](reference/excel/chartaxis.md)|_Method_> [ setCategoryNames(sourceData:Range or string[])](reference/excel/chartborder.md#setcategorynamessourcedata-rangeorstring[])|Sets all the category names for the specified axis.|1.9|
