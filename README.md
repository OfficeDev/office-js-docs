...
1. Get the latest version of Word. For details, see [Install the latest version of Office 2016](reference/word/https://dev.office.com/docs/add-ins/develop/install-latest-office-version).
