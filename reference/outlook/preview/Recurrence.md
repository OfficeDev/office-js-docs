...
The `recurrence` object provides methods to get and set the recurrence pattern of appointments but only to get the recurrence pattern of meeting requests.
...
#### recurrenceType :MailboxEnums(String) --- find the link

This is one of the following: daily, weekday, weekly, monthly, yearly.

##### Type:

* MailboxEnums (String) --- find the link
...
#### recurrenceTimeZone :[RecurrenceTimeZone](office.mailboxenums.md#recurrencetimezone-recurrencetimezone-enum)

name, offset

##### Type:

* [RecurrenceTimeZone](recurrencetimezone.md)
