...
|numberFormatLocal|object[][]|Represents Excel's number format code for the given cell as a string in the language of the user.|[1.7](../requirement-sets/excel-api-requirement-sets.md)|
...
|dataValidation|[DataValidation](datavalidation.md)|Returns a data validation object. Read-only.|[1.7](../requirement-sets/excel-api-requirement-sets.md)|
...
|[showCard()](#showcard)|void|Displays the card for an active cell if it has rich value content.|[TBD](../requirement-sets/excel-api-requirement-sets.md)|
