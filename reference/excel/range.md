...
#### Syntax
```js
rangeObject.getCellProperties(cellPropertiesLoadOptions);
```
...
#### Syntax
```js
rangeObject.getColumnProperties(columnPropertiesLoadOptions);
```
...
#### Syntax
```js
rangeObject.getRowProperties(rowPropertiesLoadOptions);
```
