...
|isEntireColumn|bool|Represents if the current range is an entire column. Read-only.|[SM](../requirement-sets/excel-api-requirement-sets.md)|
|isEntireRow|bool|Represents if the current range is an entire row. Read-only.|[SM](../requirement-sets/excel-api-requirement-sets.md)|
...
|style|string|Represents the style of the current range. If the styles of the cells are inconsistent, null will be returned.|[ApiSet.InProgressFeatures.Style](../requirement-sets/excel-api-requirement-sets.md)|
...
|dataValidation|[DataValidation](datavalidation.md)|Returns a data validation object. Read-only.|[1.7D](../requirement-sets/excel-api-requirement-sets.md)|
...
|hyperlink|[RangeHyperlink](rangehyperlink.md)|Represents the hyperlink set for the current range.|[SM](../requirement-sets/excel-api-requirement-sets.md)|
...
|[getAbsoluteResizedRange(numRows: number, numColumns: number)](#getabsoluteresizedrangenumrows-number-numcolumns-number)|[Range](range.md)|Gets a Range object with the same top-left cell as the current Range object, but with the specified numbers of rows and columns.|[SM](../requirement-sets/excel-api-requirement-sets.md)|
|[getBoundingRect(anotherRange: object)](#getboundingrectanotherrange-object)|[Range](range.md)|Gets the smallest range object that encompasses the given ranges. For example, the GetBoundingRect of "B2:C5" and "D10:E15" is "B2:E16".|[1.1](../requirement-sets/excel-api-requirement-sets.md)|
...
|[showCard()](#showcard)|void|Displays the card for an active cell if it has rich value content.|[1.7M](../requirement-sets/excel-api-requirement-sets.md)|
