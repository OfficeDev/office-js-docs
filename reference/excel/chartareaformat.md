...
|:---------------|:--------|:----------|:----|
|border|[ChartBorder](chartborder.md)|Represents the border format of chart area, which includes color, linestyle and weight. Read-only.|[Beta](../requirement-sets/excel-api-requirement-sets.md)|
