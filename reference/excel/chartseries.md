...
|:---------------|:--------|:----------|:----|
|bubbleScale|double|Returns or sets the scale factor for bubbles in the specified chart group. Can be an integer value from 0 (zero) to 300, corresponding to a percentage of the default size. Applies only to bubble charts. ReadWrite.|[ApiSet.InProgressFeatures.ChartingAPIWave2](../requirement-sets/excel-api-requirement-sets.md)|
...
|explosion|int|Returns or sets the explosion value for a pie-chart or doughnut-chart slice. Returns 0 (zero) if there's no explosion (the tip of the slice is in the center of the pie). ReadWrite.|[ApiSet.InProgressFeatures.ChartingAPIWave2](../requirement-sets/excel-api-requirement-sets.md)|
...
|firstSliceAngle|int|Returns or sets the angle of the first pie-chart or doughnut-chart slice, in degrees (clockwise from vertical). Applies only to pie, 3-D pie, and doughnut charts. Can be a value from 0 through 360. ReadWrite|[ApiSet.InProgressFeatures.ChartingAPIWave2](../requirement-sets/excel-api-requirement-sets.md)|
...
|hasLeaderLines|bool|True if Microsoft Excel show leaderlines for each datalabel in series. ReadWrite.|[ApiSet.InProgressFeatures.ChartingAPIWave2](../requirement-sets/excel-api-requirement-sets.md)|
|invertIfNegative|bool|TrueΓö¼├íif Microsoft Excel inverts the pattern in the item when it corresponds to a negative number. ReadWrite.|[ApiSet.InProgressFeatures.ChartingAPIWave2](../requirement-sets/excel-api-requirement-sets.md)|
...
|overlap|int|Specifies how bars and columns are positioned. Can be a value between ╬ô├ç├┤ 100 and 100. Applies only to 2-D bar and 2-D column charts. ReadWrite.|[ApiSet.InProgressFeatures.ChartingAPIWave2](../requirement-sets/excel-api-requirement-sets.md)|
...
|secondPlotSize|int|Returns or sets the size of the secondary section of either a pie of pie chart or a bar of pie chart, as a percentage of the size of the primary pie. Can be a value from 5 to 200. ReadWrite.|[ApiSet.InProgressFeatures.ChartingAPIWave2](../requirement-sets/excel-api-requirement-sets.md)|
|showShadow|bool|Boolean value representing if the series has a shadow or not.|[1.7](../requirement-sets/excel-api-requirement-sets.md)|
|smooth|bool|Boolean value representing if the series is smooth or not. Only applicable to line and scatter charts.|[1.7](../requirement-sets/excel-api-requirement-sets.md)|
|splitValue|double|Returns or sets the threshold value separating the two sections of either a pie of pie chart or a bar of pie chart. ReadWrite.|[ApiSet.InProgressFeatures.ChartingAPIWave2](../requirement-sets/excel-api-requirement-sets.md)|
|varyByCategories|bool|TrueΓö¼├íif Microsoft Excel assigns a different color or pattern to each data marker. The chart must contain only one series. ReadWrite.|[ApiSet.InProgressFeatures.ChartingAPIWave2](../requirement-sets/excel-api-requirement-sets.md)|
...
|:---------------|:--------|:----------|:----|
|axisGroup|[ChartAxisGroup](chartaxisgroup.md)|Returns or sets the group for the specified series. ReadWrite|[ApiSet.InProgressFeatures.ChartingAPIWave2](../requirement-sets/excel-api-requirement-sets.md)|
|dataLabels|[ChartDataLabels](chartdatalabels.md)|Represents a collection of all dataLabels in the series. Read-only.|[ApiSet.InProgressFeatures.ChartingAPIWave2](../requirement-sets/excel-api-requirement-sets.md)|
...
|splitType|[ChartSplitStype](chartsplitstype.md)|Returns or sets the way the two sections of either a pie of pie chart or a bar of pie chart are split. ReadWrite.|[ApiSet.InProgressFeatures.ChartingAPIWave2](../requirement-sets/excel-api-requirement-sets.md)|
