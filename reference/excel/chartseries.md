...
|:---------------|:--------|:----------|:----|
|bubbleScale|double|Returns or sets the scale factor for bubbles in the specified chart group. Can be an integer value from 0 (zero) to 300, corresponding to a percentage of the default size. Applies only to bubble charts. ReadWrite.|[beta](../requirement-sets/excel-api-requirement-sets.md)|
...
|gradientMaximumColor|string|Returns or sets the Color for maximum value of a region map chart series. ReadWrite.|[beta](../requirement-sets/excel-api-requirement-sets.md)|
|gradientMaximumValue|double|Returns or sets the maximum value of a region map chart series. ReadWrite.|[beta](../requirement-sets/excel-api-requirement-sets.md)|
|gradientMidpointColor|string|Returns or sets the Color for midpoint value of a region map chart series. ReadWrite.|[beta](../requirement-sets/excel-api-requirement-sets.md)|
|gradientMidpointValue|double|Returns or sets the midpoint value of a region map chart series. ReadWrite.|[beta](../requirement-sets/excel-api-requirement-sets.md)|
|gradientMinimumColor|string|Returns or sets the Color for minimum value of a region map chart series. ReadWrite.|[beta](../requirement-sets/excel-api-requirement-sets.md)|
|gradientMinimumValue|double|Returns or sets the minimum value of a region map chart series. ReadWrite.|[beta](../requirement-sets/excel-api-requirement-sets.md)|
...
|invertColor|string|Returns or sets the fill color for negative data points in a series. ReadWrite.|[beta](../requirement-sets/excel-api-requirement-sets.md)|
|invertIfNegative|bool|TrueΓö¼├íif Microsoft Excel inverts the pattern in the item when it corresponds to a negative number. ReadWrite.|[1.8](../requirement-sets/excel-api-requirement-sets.md)|
...
|showConnectorLines|bool|Returns or sets if connector lines show in a waterfall chart. ReadWrite.|[beta](../requirement-sets/excel-api-requirement-sets.md)|
|showLeaderLines|bool|True if Microsoft Excel show leaderlines for each datalabel in series. ReadWrite.|[beta](../requirement-sets/excel-api-requirement-sets.md)|
...
|splitValue|double|Returns or sets the threshold value separating the two sections of either a pie of pie chart or a bar of pie chart. ReadWrite.|[beta](../requirement-sets/excel-api-requirement-sets.md)|
|varyByCategories|bool|TrueΓö¼├íif Microsoft Excel assigns a different color or pattern to each data marker. The chart must contain only one series. ReadWrite.|[1.8](../requirement-sets/excel-api-requirement-sets.md)|
