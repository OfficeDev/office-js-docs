...
|offset|int|Represents the distance between the levels of labels, and the distance between the first level and the axis line.|[1.8](../requirement-sets/excel-api-requirement-sets.md)|
...
|:---------------|:--------|:----------|:----|
|alignment|string|Represents the alignment for the specified axis tick label. Possible values are: Center, Left, Justify, Distributed, Right.|[1.8](../requirement-sets/excel-api-requirement-sets.md)|
