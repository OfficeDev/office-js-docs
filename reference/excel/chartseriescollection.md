...
|:---------------|:--------|:----------|:----|
|[add(name: string, index: number)](#addname-string-index-number)|[ChartSeries](chartseries.md)|Add a new series to the collection.|[Beta](../requirement-sets/excel-api-requirement-sets.md)|
|[getCount()](#getcount)|int|Returns the number of series in the collection.|[1.4](../requirement-sets/excel-api-requirement-sets.md)|
|[getFirst()](#getfirst)|[ChartSeries](chartseries.md)|Gets the first series in the collection.|[Beta](../requirement-sets/excel-api-requirement-sets.md)|
...
|[getLast()](#getlast)|[ChartSeries](chartseries.md)|Gets the last series in the collection.|[Beta](../requirement-sets/excel-api-requirement-sets.md)|
