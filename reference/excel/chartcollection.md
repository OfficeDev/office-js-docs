...
|:---------------|:--------|:----------|:----|
|[add(type: string, sourceData: Range or string, seriesBy: string)](#addtype-string-sourcedata-range-or-string-seriesby-string)|[Chart](chart.md)|Creates a new chart.|[1.1](../requirement-sets/excel-api-requirement-sets.md)|
...
|sourceData|Range or string|The Range object corresponding to the source data.|
|seriesBy|string|Optional. Optional. Specifies the way columns or rows are used as data series on the chart.  Possible values are: Auto, Columns, Rows|
