...
|:---------------|:--------|:----------|:----|
|autoIndent|bool|Indicates if text is automatically indented when text alignment is set to equal distribution.|[1.9](../requirement-sets/excel-api-requirement-sets.md)|
...
|indentLevel|int|An integer from 0 to 250 that indicates the indent level.|[1.9](../requirement-sets/excel-api-requirement-sets.md)|
|readingOrder|string|The reading order for the range. Possible values are: Context, LeftToRight, RightToLeft.|[1.9](../requirement-sets/excel-api-requirement-sets.md)|
...
|shrinkToFit|bool|Indicates if text automatically shrinks to fit in the available column width.|[1.9](../requirement-sets/excel-api-requirement-sets.md)|
