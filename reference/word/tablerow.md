...
|:---------------|:--------|:----------|:----|
|cellCount|int|Gets the number of cells in the row. Read-only.|[1.3](../requirement-sets/word-api-requirement.md)|
...
|isHeader|bool|Checks whether the row is a header row. Read-only. To set the number of header rows, use HeaderRowCount on the Table object. Read-only.|[1.3](../requirement-sets/word-api-requirement.md)|
|preferredHeight|float|Gets and sets the preferred height of the row in points.|[1.3](../requirement-sets/word-api-requirement.md)|
|rowIndex|int|Gets the index of the row in its parent table. Read-only.|[1.3](../requirement-sets/word-api-requirement.md)|
|shadingColor|string|Gets and sets the shading color.|[1.3](../requirement-sets/word-api-requirement.md)|
|values|string|Gets and sets the text values in the row, as a 2D Javascript array.|[1.3](../requirement-sets/word-api-requirement.md)|
|verticalAlignment|string|Gets and sets the vertical alignment of the cells in the row. The value can be 'top', 'center' or 'bottom'. Possible values are: Mixed, Top, Center, Bottom.|[1.3](../requirement-sets/word-api-requirement.md)|
...
|:---------------|:--------|:----------|:----|
|cells|[TableCellCollection](tablecellcollection.md)|Gets cells. Read-only.|[1.3](../requirement-sets/word-api-requirement.md)|
...
|parentTable|[Table](table.md)|Gets parent table. Read-only.|[1.3](../requirement-sets/word-api-requirement.md)|

## Methods

| Method		   | Return Type	|Description| Req. Set|
|:---------------|:--------|:----------|:----|
|[clear()](#clear)|void|Clears the contents of the row.|[1.3](../requirement-sets/word-api-requirement.md)|
|[delete()](#delete)|void|Deletes the entire row.|[1.3](../requirement-sets/word-api-requirement.md)|
|[getBorder(borderLocation: string)](#getborderborderlocation-string)|[TableBorder](tableborder.md)|Gets the border style of the cells in the row.|[1.3](../requirement-sets/word-api-requirement.md)|
...
|[getNext()](#getnext)|[TableRow](tablerow.md)|Gets the next row. Throws if this row is the last one.|[1.3](../requirement-sets/word-api-requirement.md)|
|[getNextOrNullObject()](#getnextornullobject)|[TableRow](tablerow.md)|Gets the next row. Returns a null object if this row is the last one.|[1.3](../requirement-sets/word-api-requirement.md)|
...
|[merge()](#merge)|[TableCell](tablecell.md)|Merges the row into one cell.|[1.4](../requirement-sets/word-api-requirement.md)|
...
|[select(selectionMode: string)](#selectselectionmode-string)|void|Selects the row and navigates the Word UI to it.|[1.3](../requirement-sets/word-api-requirement.md)|
