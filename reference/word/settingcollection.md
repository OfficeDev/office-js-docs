...
|:---------------|:--------|:----------|:----|
|items|[Setting[]](setting.md)|A collection of setting objects. Read-only.|[1.4](../reqset/word-requirement.md)|
...
|:---------------|:--------|:----------|:----|
|[deleteAll()](#deleteall)|void|Deletes all settings in this add-in.|[1.4](../reqset/word-requirement.md)|
|[getCount()](#getcount)|int|Gets the count of settings.|[1.4](../reqset/word-requirement.md)|
|[getItem(key: string)](#getitemkey-string)|[Setting](setting.md)|Gets a setting object by its key, which is case-sensitive.|[1.4](../reqset/word-requirement.md)|
...
|[set(key: string, value: object)](#setkey-string-value-object)|[Setting](setting.md)|Creates or sets a setting.|[1.4](../reqset/word-requirement.md)|
