...
|:---------------|:--------|:----------|:----|
|first|[ContentControl](contentcontrol.md)|Gets the first content control in this collection. Read-only.|1.3||
...
|[getByTypes(types: ContentControlType[])](#getbytypestypes-contentcontroltype)|[ContentControlCollection](contentcontrolcollection.md)|Gets the content controls that have the specified types andor subtypes.|1.3|
