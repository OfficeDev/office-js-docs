...
### getRanges(delimiters: string[], excludeDelimiters: bool, trimWhite: bool)  ![new](../media/new.jpg)
...
#### Additional details
The method will return text (as ranges) within the specified delimiters and if so applicable  within paragraphs, content controls and tables.

Note that ending marks options is not supported in this method.
