...
|:---------------|:--------|:----------|
|height|**float**|Gets or sets a number that describes the height of the inline image, in points.|
...
|width|**float**|Gets or sets a number that describes the width of the inline image, in points.|
